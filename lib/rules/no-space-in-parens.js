    ...
    create(context) {
        ...
        function getTemplateLiteralsСoordinates(tokens) {
            ...
            const templateLiteralsChunks = templateLiterals.reduce((acc, templateLiteral) => {
                ...
                const isTemplateLiteral = firstSymbol === "`" && lastSymbol === "`";
        ...
        return {
            Program: function checkParenSpaces(node) {
                ...
                tokens.forEach( function( token, i ) {
                    ...
                    if (token.type === "Template") {
                        ...
                        if (!isSingleTemplateLiteral) {
                            currentTemplateLiteral = {
                                startToken: coordinatePair[0].token,
                                endToken: coordinatePair[1].token,
                            };
                    ...
                    if (options.parenStringException && (stringInParenAlreadyChecked(tokens, i) || stringInParenAlreadyCheckedTemplateLiterals(tokens, i, templateLiteralsСoordinates))) {
                        return;
                    }
