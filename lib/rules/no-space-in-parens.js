...
module.exports = {
    ...
    create(context) {
        ...
        function checkStringOrTemplateLiteralInParen(node, prevToken, currentTemplateLiteral, nextToken) {
        ...
        function templateLiteralInParenAlreadyChecked(tokens, i, templateLiteralsСoordinates) {
            if (!tokens[ i ]) {
                return false;
            }
                ...
                tokens.forEach( function( token, i ) {
                    ...
                    */
                    ...
                    if (
                        ...
                        checkStringOrTemplateLiteralInParen(node, prevToken, currentTemplateLiteral, nextToken);
                        return;
                    }

                    if (
                        options.parenStringException &&
                        (stringInParenAlreadyChecked(tokens, i) || templateLiteralInParenAlreadyChecked(tokens, i, templateLiteralsСoordinates))
                    ) {
                        return;
                    }
